angular.module('app.viewer').config(function($stateProvider) {
    $stateProvider.state('viewer.channels.all', {
        url: '/',
        templateUrl: 'app/viewer/views/channels/channels-all/channels-all.html',
        controller: function($scope, $state, NgTableParams, InitSrv, StateSrv, VideosSrv, ChannelsSrv) {
            ...
            $scope.one = function(channel) {
                $state.go('viewer.channels.one', { channelId: channel.id });
            };
