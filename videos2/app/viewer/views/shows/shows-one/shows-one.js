angular.module('app.viewer').config(function($stateProvider) {
    $stateProvider.state('viewer.shows.one', {
        url: '/:showId',
        templateUrl: 'app/viewer/views/shows/shows-one/shows-one.html',
        controller: function($scope, $stateParams, InitSrv, VideosSrv, ShowsSrv) {
            $scope.init = function() {
