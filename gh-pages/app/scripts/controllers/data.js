...
app.controller('DataCtrl', function($scope, $rootScope, $document, $q, $timeout, $filter, uuid4, StateSrv, DataSrv) {
    ...
    $scope.listGroupShows = function(show) {
        var match = show.match(/\[E\]/i)
        if (match) {
            return 'Events';
        }
