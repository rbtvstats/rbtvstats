...
/**
 * @ngdoc function
 * @name rbtvCrawlerApp.controller:ImportExportCtrl
 * @description
 * # ImportExportCtrl
 * Controller of the rbtvCrawlerApp
 */
app.controller('ImportExportCtrl', function($scope, $filter, $timeout, StateSrv, VideosSrv, ChannelsSrv, ShowsSrv, HostsSrv, SeriesSrv) {
    $scope.init = function() {
